...
- Luego solicita los campos obligatorios según reglas_validacion_datos.
- Luego pregunta sobre la configuracion base, preguntando los campos que aparecen en el archivo @configuracion-base.json en el objeto "configuracion_negocio" ( hace 5 preguntas dentro de un prompt para que sea contestada 1 por 1 separada por puntos).
- luego pregunta sobre el o los colores principales y estilo visual que aparecen en @configuracion-base.json en el objeto "estilo_visual" para la pagina.
